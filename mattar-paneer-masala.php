                ...
                <div id="recipeContainer">
                    <div id="ingredients">
                        ...
                        <ul>
                            ...
                            <li>1/2 tsp - Red Chili Powder (to taste)</li>
                            <li>1 tsp - Salt (to taste)</li>
                            <li>1 Tps - Fenugreek, dry herb</li>
                        </ul>
                        <hr>
                        <h5>Main Ingredients</h5>
                        <ul>
                            <li>1 1/2 tbsp - Canola Oil</li>
                            <li>2 - Dry Red Chili Peppers</li>
                            <li>2 - Cinnamon Sticks (~4in each)</li>
                            <li>2 - Cloves</li>
                            ...
                            <li>1/4 lb - Paneer, cut into 1/2 inch cubes</li>
                        </ul>
                        <hr>
                        <h5>Garnish</h5>
                        <ul>
                    ...
                    <div id="steps">
                        <h3>Preparation</h3>
                        <p>
                            Combine all of the Spice Mix ingredients into a cup, and set aside for later.
                            If you're using frozen peas, defrost them completely.
                            Finely dice the onion and tomato, and cut the Paneer.
                        </p>
                        <hr>
                        <h3>Directions</h3>
                        <ul>
                            ...
                            <li>
                                ...
                                If the onions start to burn, reduce heat. Note: the richer the color of the onions,
